              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Contact Us</h3>
                    <address>
                      <p> 1005, Ukvalley Technologies, Roongta Business centre, Govind Nagar, Nashik</p>
                      <p><span class="fa fa-phone">     </span>+919890437811</p>
                      <p><span class="fa fa-envelope">  </span>Ukvalleytech@gmail.com</p>
                    </address>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="http://ukvalley.com/">Ukvalley Technologies</a></p>
