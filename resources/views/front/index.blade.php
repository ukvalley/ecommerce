        ...
        <ul class="seq-canvas">
          ...
          <li>
            ...
            <div class="seq-title">
              ...
              <a data-seq target="_blank" href="{{$list->btn_link}}" class="aa-shop-now-btn aa-secondary-btn">
                {{-- Button txt --}}
                {{$list->btn_txt}}</a>
            </div>
            @endif
        ...
        <div class="col-md-12">
          <div class="aa-client-brand-area">
            <ul class="aa-client-brand-slider">
              ...
              <li><a href="#"><img src="{{asset('storage/media/model/'.$list->image)}}" alt="{{$list->name}}"></a></li>
              @endforeach
            </ul>
          </div>
        </div>
